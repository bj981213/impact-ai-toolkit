...
- 21 個 Prompt 工具與 5 個 AI Agent 指令
...
正式網站：<https://bj981213.github.io/impact-ai-toolkit/?v=2.8.0>
...
- `toolbox: "prompt"` 的工具只能使用 `prompt`，提供使用者單次貼入 AI 的完整提示詞。
- `toolbox: "agent"` 的工具只能使用 `instructions`，提供貼入 Agent 指令欄的任務規則；不得使用 `prompt`。
