...
<body class="detail-body" data-item-id="${escapeAttr(item.id)}" data-item-title="${escapeAttr(item.title)}" data-item-kind="${escapeAttr(item.kind)}">
  ...
  <main class="detail-main" id="main">
    ...
    <section class="detail-hero">
      <div class="detail-tags"><span>${escapeHtml(item.kind)}</span><span>${escapeHtml(stage.title)}</span>${tools}</div>
